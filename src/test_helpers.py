import unittest
from helpers import (
  markdown_to_html_node, split_nodes_delimiter, extract_markdown_images, extract_markdown_links,
...
"""
    ...
    self.assertEqual(
        html,
        "<div><h3>This is a h3 heading</h3></div>",
    )

  def test_quote(self):
    md = """
> This is a quoteblock.
> It can have **inline bold** text,
> or a `code line`
"""
    ...
    self.assertEqual(
        html,
        '<div><blockquote>This is a quoteblock. It can have <b>inline bold</b> text, or a <code>code line</code></blockquote></div>',
    )

  def test_unordered_list(self):
    md = """
- Unordered item 1
- Unordered item 2 with **bold text**
- Unordered item 3 with `code` and _italics_!
"""
